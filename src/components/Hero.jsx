                ...
                <div className="flex flex-row justify-between flex-wrap -mx-3">
                    <div className="lg:w-1/3 w-full px-3">
                        ...
                        <div className='flex gap-3 sm:gap-4 max-lg:justify-center'>
                            <button className='py-3 sm:px-8 px-4 group whitespace-nowrap bg-red hover:bg-white transition duration-300 rounded-lg'><a className='text-white font-oswald transition duration-300 lg:text-lg text-base font-bold group-hover:text-red flex items-center gap-3' href=""><svg className='group-hover:fill-red fill-white' width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button className='py-3 sm:px-8 px-4 font-oswald whitespace-nowrap bg-red hover:bg-white text-white transition duration-300 text-lg font-bold hover:text-red rounded-lg'>
