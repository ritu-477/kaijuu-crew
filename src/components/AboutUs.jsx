...
const AboutUs = () => {
  return (
      <div className='bg-charcoal-black -mt-1 pt-12 lg:pt-24 xl:pt-[65px] pb-12 sm:pb-16 md:pb-24 lg:pb-24 xl:pb-[135.84px]' id='about'>
          <div className='container'>
              <div className='flex flex-row justify-between flex-wrap -mx-3 max-lg:justify-center'>
                  <div className='lg:w-[55%] w-full px-3 flex flex-col justify-center max-lg:items-center'>
                      <CommonHeading
                          className=""
                          text={<><span className="text-red">About</span>{' '}<span className="text-white">Us</span></>
                          }
                      />
                      <CommonPara className='lg:max-w-[630px] lg:text-start text-center w-full sm:pt-7 pt-4' text={`It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, 
                  ...
                  <div className='lg:w-[45%] w-full px-3 flex lg:justify-end justify-center lg:mt-0 mt-5'>
