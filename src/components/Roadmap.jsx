            ...
            <div className='container'>
                ...
                <div className='xl:block hidden'>
                    <div className='max-w-[1320px] mx-auto relative lg:mb-[250px] md:mb-16 sm:mb-14 mb-12'>
                        <img className='absolute pointer-events-none top-[47%] xl:left-[16%] max-w-[167px]' src={ellipseONE} alt="ellipse-one" />
                        ...
                        <img className='absolute pointer-events-none top-[50%] xl:right-[16%] max-w-[167px]' src={ellipseTwo} alt="ellipse-one" />
